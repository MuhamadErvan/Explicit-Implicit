package com.example.belajarexplicitimplicit;
...
import com.example.belajarexplicitimplicit.IntentActivity;
    ...
    public void onClick(View v) {
        switch(v.getId()){
            ...
            case R.id.implicitIntent :
                Intent implicit = new Intent(Intent.ACTION_VIEW, Uri.parse("https://1cak.com/"));
